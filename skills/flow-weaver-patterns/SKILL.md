...
description: Create and use reusable workflow patterns. Patterns are partial workflows with IN/OUT ports that can be applied to existing workflows or extracted from them.
---
...
- `flow-weaver:flow-weaver-concepts` - Core workflow concepts
- `flow-weaver:flow-weaver-export-interface` - Workflow ports and interfaces
- `flow-weaver:flow-weaver-iterative-development` - Building workflows step-by-step
